...
sea_level <- read.csv("C:/Users/Omar/Desktop/Applied Statistics/Assessment/Sea_level.csv", sep = ",", header = TRUE)

greenland_mass <- read.csv("C:/Users/Omar/Desktop/Applied Statistics/Assessment/Greenland_Mass.csv", sep = ",", header = TRUE)

antarctica_mass <- read.csv ("C:/Users/Omar/Desktop/Applied Statistics/Assessment/Antarctica_Mass.csv", sep = ",", header = TRUE)
...
car::vif(model3)  # since VIF > 10 , then we can not add the two variables in one model
